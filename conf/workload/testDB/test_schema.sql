...
GRANT SELECT(patient_id) ON surveillance TO public_attribute;
GRANT SELECT(visit_no) ON surveillance TO public_attribute;
-- GRANT SELECT(primary_) ON surveillance TO public_attribute;
-- GRANT SELECT(diag_src) ON surveillance TO protected_attribute;
-- GRANT SELECT(icd9) ON surveillance TO protected_attribute;
-- GRANT SELECT(major_icd9) ON surveillance TO protected_attribute;
